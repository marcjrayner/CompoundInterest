...
class CalculationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calculation" do
    assert_difference('Calculation.count') do
      post calculations_url, params: { calculation: { interest_rate: @calculation.interest_rate, name: @calculation.name, principal: @calculation.principal, years: @calculation.years } }
    end
  ...
  test "should update calculation" do
    patch calculation_url(@calculation), params: { calculation: { interest_rate: @calculation.interest_rate, name: @calculation.name, principal: @calculation.principal, years: @calculation.years } }
