...
const Calculator = ({ userSignedIn, userData }) => {
  ...
  const {
    value: interestRate,
    bind: bindInterestRate,
    reset: resetInterestRate,
  } = useInput("");
  ...
  const getCalculationResult = () => {
    ...
    axios
      .post("get_compound_interest", data)
      .then((response) => {
  ...
  return (
    <div className="bg-light p-5 m-3 container text-center">
      ...
      <div className="row justify-content-center">
        <div style={{ width: "25rem" }}>
          ...
          <br />
          <button className="btn btn-primary" onClick={getCalculationResult}>
            Calculate
          </button>
          ...
          {result > 0 && checkAllValues && (
            <>
              <br />
              <p>
                {`After ${years} years, with an interest rate of ${interestRate}% compounding annually, your ${currencySymbol}${principal}`}{" "}
                will grow to:
              </p>
              <h2>
                {currencySymbol}
